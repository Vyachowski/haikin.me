...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Personal blog of a software developer that creates a fast and easy-to-maintain solutions for businesses."/>
        <meta name="author" content="Slava Haikin">
        <title>From Programmer to Software Engineer</title>
    ...
    <body>
        <header class="header">
            <a class="logo">
                <span class="logo__content">S</span>
                <span class="logo__content logo__content--accent">H</span>
            </a>
            ...
            <nav class="header__navbar">
                <ul class="header__nav list">
                    ...
                    <li class="header__nav-item">
                        <a class="header__nav-link header__nav-link--active" href="blog.php">Blog</a>
                    </li>
                </ul>
                <div class="header__divider"></div>
                <ul class="header__socials list list--horizontal">
                    <li class="header__socials-item">
                        <a class="header__socials-link" href="https://twitter.com/vyachowski" target="_blank" aria-label="Link to author's Twitter profile">
                    ...
                    <li class="header__socials-item">
                        <a class="header__socials-link" href="https://github.com/vyachowski" target="_blank" aria-label="Link to author's Github profile">
                    ...
                    <li class="header__socials-item">
                        <a class="header__socials-link" href="https://www.linkedin.com/in/vyachowski/" target="_blank" aria-label="Link to author's Linkedin profile">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none">
    ...
    <section class="preview-list">
            <article class="preview-card">
                <header class="preview-card-header">
                    <time class="preview-card-timestamp" datetime="2023-01-27 9:01">
                        <small>January 27, 2024</small>
                    </time>
                    <picture class="preview-card-image-set">
                        <!-- Источник для больших экранов -->
                        <source media="(min-width: 1200px)" srcset="images/hero-desktop-2x.png">

                        <!-- Источник для средних экранов -->
                        <source media="(min-width: 600px)" srcset="images/hero-desktop-2x.png">

                        <!-- Источник для маленьких экранов или по умолчанию -->
                        <img class="preview-card-image" src="images/hero-desktop-2x.png" width="150" height="150" alt="An image of a software developer – Slava Haikin">
                    </picture>
                    <h2 class="preview-card-title">
                        Hi, my name is Slava&nbsp;Haikin
                    </h2>
                </header>
                <main class="preview-card-content">
                    <p class="preview-card-text">
                        I am a T-shaped web developer, with a speciality in Front-end and also familiar with
                        a backend (Python and Node.js) and also databases.
                        My focus is in understanding business purposes and provide a decisions that can hugely increase them
                    </p>
                </main>
                <footer class="preview-card-footer">
                    <div class="preview-card-features">
                        <span class="preview-card-features-text">Tech stack:</span>
                        <ul class="preview-card-features-list">
                            <li class="preview-card-features-item typescript-term">
                            ...
                            <li class="preview-card-features-item react-term">
                            ...
                            <li class="preview-card-features-item tailwind-term">
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" viewBox="0 0 23 22" fill="currentColor">
                    ...
                    <div class="preview-card-buttons-wrapper">
                        <a class="promo-card-link button button-cta" href="#">Download&nbsp;CV</a>
                        <a class="promo-card-link button button-cta-secondary" href="#">Connect</a>
                    </div>
                </footer>
            </article>
            <article class="preview-card">
                <header class="preview-card-header">
                    ...
                    <h2 class="preview-card-title">Hello!</h2>
                </header>
                <main class="preview-card-content">
                    <p class="preview-card-text">
                        ...
                        unchanged. It was popularised in the 1960s with the release of enetreset
                        sheets containing Lorem Ipsum passages.
                    </p>
                </main>
                <footer class="preview-card-footer">
                    <div class="preview-card-buttons-wrapper">
                        <a class="preview-card-link button button-cta-secondary" href="#">Read more</a>
                    </div>
                </footer>
            </article>
        </section>
                ...
                <nav class="footer__navbar">
                    <ul class="footer__nav-list list list--horizontal">
                        <li class="footer__nav-item">
                            <a class="footer__nav-link footer__nav-link--active" href="#">Blog</a>
                        </li>
                        <li class="footer__nav-item">
                            <a class="footer__nav-link" href="#">Services</a>
                        </li>
                        <li class="footer__nav-item">
                            <a class="footer__nav-link" href="#">Projects</a>
                        </li>
                        <li class="footer__nav-item">
                            <a class="footer__nav-link" href="#">CV&nbsp;&&nbsp;Contacts</a>
                        </li>
                    </ul>
                </nav>
