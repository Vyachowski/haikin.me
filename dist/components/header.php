  ...
  <nav class="header__navbar">
    <ul class="header__nav list">
      <li class="header__nav-item">
        <a class="header__nav-link header__nav-link--active" href="#">Blog</a>
      </li>
      <li class="header__nav-item">
        <a class="header__nav-link" href="services.html">Services</a>
      </li>
      <li class="header__nav-item">
        <a class="header__nav-link" href="projects.html">Projects</a>
      </li>
      <li class="header__nav-item">
        <a class="header__nav-link" href="contacts.html">CV&nbsp;&&nbsp;Contacts</a>
      </li>
    </ul>
...
<!--      <option class="language-select-option" value="index.php">En</option>-->
<!--      <option class="language-select-option" value="/ru/index.php">Ру</option>-->
<!--    </select>-->
<!--  </label>-->
